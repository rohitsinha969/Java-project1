...
public class page3 {
    public static void main(String[] args) {
        ...
        // System.out.println("This calculator can calculate your CBSE percentage
        // depending on your marks");
        // System.out.println("Give me your marks(out of 100) and i will tell you your
        // percentage");
        // System.out.println("Total marks for respective subjects are 440
        // (70+70+100+100+100)");
        // float b=440;
        ...
        // System.out.println("Enter the marks you scored in Physical Education (out of
        // 100)");
        // float ped = marks.nextFloat();
        // float a1= (phy+chem+maths+eng+ped)/b;
        // float a2= a1*100;
        // System.out.println(a2);
        System.out.println("Tell me your name plz!");
        String Hname = name.next();
        System.out.println("Helloooooo bro " + Hname + " How are you doin' today ?");
        marks.close();
        name.close();
    }
}
